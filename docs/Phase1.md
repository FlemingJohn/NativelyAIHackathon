...
> **Historical.** Records the Next.js + Express build, whose folders have since
> been removed. Phase 2 moved everything into [`nativebuilder/`](../nativebuilder/)
> for the hackathon submission. Kept for the data-source status and the live
> test results, which still describe how the modules behave.
